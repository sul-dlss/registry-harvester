...
cat $LOG/folio_inactive.log | egrep 'message|createdRecords|updatedRecords|failedRecords|failedUsers|errorMessage|totalRecords' | mailx -s "Folio Userload: Deactivated Users Summary for folio_inactive.log.$DATE" sul-unicorn-devs@lists.stanford.edu
